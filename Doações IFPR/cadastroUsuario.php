<?php include "header.php" ?>
    ...
    <section class="mt-1 pb-2 padding-bottom: 20px min-height: 20vh align-items: flex-start">
        ...
        <div class="d-flex justify-content-center mb-5">
            ...
            <div class="d-flex align-items-center justify-content-center" style="min-height: 5vh;">

            <div class="row">
                <div class="col">
                    
                    <h4 class="text-center"style="color: #021c0e;">Cadastro de Usuário:</h4>
