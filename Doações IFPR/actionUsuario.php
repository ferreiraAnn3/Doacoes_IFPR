<?php 
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        // 3. INSERÇÃO NO BANCO (USANDO TRANSAÇÃO)
        if (!$erroPreenchimento) {
            ...
            try {
                ...
                // Vínculo nas tabelas específicas
                ...
                mysqli_rollback($conn); // Se algo der errado, desfaz tudo
...
?>
    ...
    <style>
        .bg-gradient-verde-claro {
            /* Degradê suave idêntico ao do formulário (do centro/topo mais claro para as bordas levemente verdes) */
            background: linear-gradient(135deg, #f0f7f0 0%, #c8e0c8 100%);
            /* Garante altura suficiente para centralizar */
        ...
        <div class="container text-center">
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6">
                    <!-- O Card Branco no meio do degradê -->
