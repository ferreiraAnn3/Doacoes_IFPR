    ...
    <div class="container">
        ...
        <section class="py-5 border-bottom" style="background:#FFFBF0;">        <div class="row text-center g-4">
                ...
                if($filtroDoacao == 'todos'){
                    // MODIFICADO AQUI: Agora "todos" significa "todos os itens que ainda estão disponíveis"
                ...
                elseif($filtroDoacao == 'disponivel'){
                    ...
                    // O else continua puxando 'doado' apenas se o usuário clicar no filtro específico de itens já doados
