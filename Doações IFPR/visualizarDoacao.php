<?php
    ...
    if(isset($_GET['idItem'])){
        ...
        // QUERY buscando o item e os dados do doador associado (através da relação de chaves estrangeiras)
        ...
        if(mysqli_num_rows($resItem) > 0){
            ...
            // Variáveis locais para facilitar a exibição
            $idItem         = $item['id_item'];
            $titulo         = $item['titulo'];
    ...
    <div class="container px-4 px-lg-5 my-5">
        <div class="row gx-4 gx-lg-5 align-items-center">
            ...
            <div class="col-md-6">
                ...
                <?php
                    // Lógica de botões baseada no status e nível de acesso
