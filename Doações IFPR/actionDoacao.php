<?php 
    ...
    // Verifica se o formulário foi enviado via POST (impede acesso direto pela URL)
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        
        // Validação de Segurança Rigorosa: Apenas Doadores podem processar esta ação
        ...
        // Filtra e valida os dados de texto (os 'names' aqui devem ser iguais aos do formDoacao.php)
...
// Altere esta linha no seu código atual:
echo "<div class='container mt-5 mb-5' style='margin-top: 150px !important;'>";            echo "<div class='alert alert-success text-center shadow-sm p-4'>
        ...
        // Redireciona via JavaScript se não for POST (evita problemas com headers already sent)
        echo "<script>window.location.href='formDoacao.php';</script>";
        exit();
    }

    // Função de tratamento de dados (Segurança)
