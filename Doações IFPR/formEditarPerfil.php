...
// Consulta SQL corrigida: seleciona tudo necessário e garante o JOIN
...
// Se não encontrar nada, define um array vazio para evitar erros
if (!$dados) {
...
<style>
    /* O degradê verde institucional */
    .fundo-degrade-verde {
        background: linear-gradient(135deg, #f0f7f0 0%, #c8e0c8 100%);
        min-height: 85vh; 
        padding-top: 155px; /* Mantive o mesmo espaçamento que você tinha */
        padding-bottom: 50px;
    }
    
    /* Deixando o seu card mais arredondado e destacado */
    .card-formulario {
        border-radius: 15px;
        border: none;
...
<!-- Envolvi o seu container com o fundo degradê -->
